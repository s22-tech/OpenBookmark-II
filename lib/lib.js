...
function bookmarkmove(subdir, bmlist) {
	if (bmlist == '') {
		...
		bookmark_move = window.open(subdir + '/bookmarks/move_bookmark.php', 'bmlist', 'toolbar=no,location=no,status=no,scrollbars=yes,resizable=yes,width=500,height=450');
	}
}
